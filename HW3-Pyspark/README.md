...
#### Parts 1, 2 Due: Tuesday April 18, 2017, 11:59 PM
#### Parts 3, 4 Due: Tuesday April 25, 2017, 11:59 PM
...
If you haven't already, peruse the [discussion notebook](http://sist.shanghaitech.edu.cn/faculty/hexm/pyspark-tutorial.zip) as a refresher on iterators, generators, and lambdas. You don't have to do this, but familiarity will make your life significantly easier :)
...
## Testing
At the bottom of each notebook will be several tests** - run them to check and verify your output.  Your test output (along with diffs, if your test fails) will be located in `your_output/`, and reference output is in `ref_output_dir/`. We will be grading on a separate, more rigorous set of tests, so you are encouraged to write tests yourself.  

_**featuring Shakespeare's [As You Like It](http://shakespeare.mit.edu/asyoulikeit/full.html)_

## Submission instructions
To submit the first two parts of this assignment, due **4/18 at 11:59 pm**, push your submission (with your code in `HW3_I.ipynb`) to github repo. **Please do not change this notebook file when you work on the second notebook.**

To submit the second two parts of this assignment, due **4/25 at 11:59 pm**, push your submission (with your code in `HW3_II.ipynb`) to github repo.
